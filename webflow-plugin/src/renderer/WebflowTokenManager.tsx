...
const WebflowTokenManager = (
	props: CustomSettingsComponentProps,
): JSXElement => {
			...
			<div style="padding: 12px 16px;">
					...
					<div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px; padding: 10px 12px; background: #1a3a1a; border-radius: 6px; border: 1px solid #2a4a2a;">
						...
						<div>
							...
							<div style="font-size: 11px; color: #888; margin-top: 2px;">
								{validTokens().length} active token
				...
				<Show when={!hasValidToken()}>
					<div style="font-size: 11px; color: #888; margin-bottom: 12px;">
						Connect to Webflow to sync components, manage assets, and deploy to
						Webflow Cloud.
					</div>
				</Show>
				...
				<Show when={isAuthenticating()}>
					<div style="font-size: 11px; color: #888; text-align: center; margin-bottom: 12px;">
						...
						<br />
						Complete authentication in your browser and this window will update
						automatically.
					</div>
				</Show>
					...
					{(token) => (
						<div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px; padding: 8px; background: #2a2a2a; border-radius: 4px;">
							<div style="flex: 1; min-width: 0;">
								...
								<Show when={token.error}>
									<div
										role="button"
										tabIndex={0}
										style="font-size: 10px; color: #ff6b6b; margin-top: 2px;"
									>
										{token.error}
									</div>
								</Show>
							...
							<button
								...
								onKeyDown={(e) => {
									if (e.key === "Enter" || e.key === " ") removeToken(token.id);
								}}
							>
								Remove
							</button>
