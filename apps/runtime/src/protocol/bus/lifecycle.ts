...
export const LIFECYCLE_SEQUENCES: Record<string, string[]> = {
  "runtime.session.attach": ["runtime.session.attach.started", "runtime.session.attached", "runtime.session.attach.failed"],
  "runtime.lane.create": ["runtime.lane.create.started", "runtime.lane.created", "runtime.lane.create.failed"],
  "runtime.terminal.spawn": [
    "runtime.terminal.spawn.started",
    "runtime.lane.attach.started",
    "runtime.terminal.spawned",
    "runtime.lane.attached",
    "runtime.lane.attach.failed",
    "runtime.terminal.spawn.failed",
  ],
  "runtime.lane.attach": ["runtime.lane.attach.started", "runtime.lane.attached", "runtime.lane.attach.failed"],
};
