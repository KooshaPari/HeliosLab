...
export const TOPICS: readonly string[] = [
  ...
  "runtime.renderer.switch.started",
  "runtime.renderer.switch.succeeded",
  "runtime.renderer.switch.failed",
  "runtime.agent.run.started",
  "runtime.agent.run.progress",
  ...
  "runtime.boundary.local.dispatched",
  "runtime.boundary.tool.dispatched",
