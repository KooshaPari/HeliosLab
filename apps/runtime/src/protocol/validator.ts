...
const CORRELATION_REQUIRED_TOPICS = new Set<string>([
  "runtime.lane.attach.started",
  "runtime.lane.attach.failed",
  "runtime.lane.cleanup.started",
  "runtime.lane.cleanup.failed",
  "runtime.lane.create.started",
  "runtime.lane.created",
  "runtime.lane.create.failed",
  "runtime.session.attach.started",
  "runtime.session.attached",
  "runtime.session.attach.failed",
  "runtime.session.terminate.started",
  "runtime.session.terminate.failed",
  "runtime.session.terminated",
  "runtime.terminal.spawn.started",
  "runtime.terminal.spawned",
  "runtime.terminal.spawn.failed",
  "terminal.output",
...
> = {
  "runtime.lane.create": ["workspace_id"],
  "runtime.lane.attach": ["workspace_id", "lane_id"],
  "runtime.lane.cleanup": ["workspace_id", "lane_id"],
  "runtime.session.attach": ["workspace_id", "lane_id", "session_id"],
  "runtime.session.terminate": ["workspace_id", "lane_id", "session_id"],
  "runtime.terminal.spawn": ["workspace_id", "lane_id", "session_id"],
  "runtime.terminal.input": ["workspace_id", "lane_id", "session_id", "terminal_id"],
  "runtime.terminal.resize": ["workspace_id", "lane_id", "session_id", "terminal_id"],
};
...
const TOPIC_CONTEXT_REQUIREMENTS: Record<
  ...
  Array<"workspace_id" | "lane_id" | "session_id" | "terminal_id">
> = {
  "runtime.lane.attach.started": ["workspace_id", "lane_id"],
  "runtime.lane.attach.failed": ["workspace_id", "lane_id"],
  "runtime.lane.cleanup.started": ["workspace_id", "lane_id"],
  "runtime.lane.cleanup.failed": ["workspace_id", "lane_id"],
  "runtime.lane.create.started": ["workspace_id", "lane_id"],
  "runtime.lane.created": ["workspace_id", "lane_id"],
  "runtime.lane.create.failed": ["workspace_id", "lane_id"],
  "runtime.session.attach.started": ["workspace_id", "lane_id", "session_id"],
  "runtime.session.attached": ["workspace_id", "lane_id", "session_id"],
  "runtime.session.attach.failed": ["workspace_id", "lane_id", "session_id"],
  "runtime.session.terminate.started": ["workspace_id", "lane_id", "session_id"],
  "runtime.session.terminate.failed": ["workspace_id", "lane_id", "session_id"],
  "runtime.session.terminated": ["workspace_id", "lane_id", "session_id"],
  "runtime.terminal.spawn.started": ["workspace_id", "lane_id", "session_id"],
  "runtime.terminal.spawned": ["workspace_id", "lane_id", "session_id", "terminal_id"],
  "runtime.terminal.spawn.failed": ["workspace_id", "lane_id", "session_id"],
