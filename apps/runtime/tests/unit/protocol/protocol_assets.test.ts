  ...
  test("keeps contract schema conditional required fields aligned with runtime guards", () => {
    ...
    expect(methodRequired).toEqual(
      new Map<string, string[]>([
        ["runtime.lane.create", ["correlation_id", "workspace_id"]],
        ["runtime.session.attach", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
        ["runtime.terminal.spawn", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
      ])
    );
    expect(topicRequired).toEqual(
      new Map<string, string[]>([
        ["runtime.lane.attach.started", ["correlation_id", "lane_id", "workspace_id"]],
        ["runtime.lane.attach.failed", ["correlation_id", "lane_id", "workspace_id"]],
        ["runtime.lane.cleanup.started", ["correlation_id", "lane_id", "workspace_id"]],
        ["runtime.lane.cleanup.failed", ["correlation_id", "lane_id", "workspace_id"]],
        ["runtime.lane.create.started", ["correlation_id", "lane_id", "workspace_id"]],
        ["runtime.lane.created", ["correlation_id", "lane_id", "workspace_id"]],
        ["runtime.lane.create.failed", ["correlation_id", "lane_id", "workspace_id"]],
        ["runtime.session.attach.started", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
        ["runtime.session.attached", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
        ["runtime.session.attach.failed", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
        ["runtime.session.terminate.started", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
        ["runtime.session.terminate.failed", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
        ["runtime.terminal.spawn.started", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
        [
          "runtime.terminal.spawned",
          ["correlation_id", "lane_id", "session_id", "terminal_id", "workspace_id"],
        ],
        ["runtime.terminal.spawn.failed", ["correlation_id", "lane_id", "session_id", "workspace_id"]],
      ])
    );
  });
