...
describe("BusAuditSubscriber", () => {
  ...
  describe("event mapping", () => {
    it("should map runtime.lane.created to lane.lifecycle audit event", async () => {
      subscriber.subscribe(mockBus, sink);

      const event: BusEvent = {
        topic: "runtime.lane.created",
    ...
    it("should map runtime.session.created to session.lifecycle audit event", async () => {
      subscriber.subscribe(mockBus, sink);
