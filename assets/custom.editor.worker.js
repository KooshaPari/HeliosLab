...
(() => {
	...
	var _DisposableMap = class {
		...
		set(key, value, skipDisposeOnOverwrite = false) {
			...
			if (!skipDisposeOnOverwrite) {
				(_a3 = this._store.get(key)) === null || _a3 === void 0
					? void 0
					: _a3.dispose();
			}
	...
	function localize(_data, message, ...args) {
	...
	var _isWebWorker = _isWeb && typeof globals.importScripts === "function";
	var userAgent = _userAgent;
	var setTimeout0IsFaster =
	...
	var _isFirefox = !!(userAgent && userAgent.indexOf("Firefox") >= 0);
	var _isSafari = !!(
		!isChrome &&
		userAgent &&
		userAgent.indexOf("Safari") >= 0
	);
	var _isEdge = !!(userAgent && userAgent.indexOf("Edg/") >= 0);
	var _isAndroid = !!(userAgent && userAgent.indexOf("Android") >= 0);
	...
	var Stacktrace = class {
		static create() {
			...
			return new Stacktrace(
				(_a3 = new Error().stack) !== null && _a3 !== void 0 ? _a3 : "",
			);
		}
		constructor(value) {
			this.value = value;
	...
	var Emitter = class {
		constructor(options) {
			...
			this._leakageMon =
				...
				((_a3 = this._options) === null || _a3 === void 0
					? void 0
					: _a3.leakWarningThreshold)
					? new LeakageMonitor(
							(_c =
		...
		dispose() {
			...
			if (!this._disposed) {
						...
						queueMicrotask(() => {
							...
							for (const listener of listeners) {
								if (listener.subscription.isset()) {
									...
									(_a4 = listener.stack) === null || _a4 === void 0
										? void 0
										: _a4.print();
								}
							}
				...
				(_a3 = this._deliveryQueue) === null || _a3 === void 0
					? void 0
					: _a3.clear(this);
				(_c =
					(_b = this._options) === null || _b === void 0
	...
	var _UTF8_BOM_CHARACTER = String.fromCharCode(
		65279,
		/* CharCode.UTF8_BOM */
	);
	...
	var _normalize = platformIsWin32 ? win32.normalize : posix.normalize;
	var _resolve = platformIsWin32 ? win32.resolve : posix.resolve;
	var _relative = platformIsWin32 ? win32.relative : posix.relative;
	var _dirname = platformIsWin32 ? win32.dirname : posix.dirname;
	var _basename = platformIsWin32 ? win32.basename : posix.basename;
	var _extname = platformIsWin32 ? win32.extname : posix.extname;
	var _sep = platformIsWin32 ? win32.sep : posix.sep;
	...
	var CancellationTokenSource = class {
		...
		dispose(cancel = false) {
			...
			(_a3 = this._parentListener) === null || _a3 === void 0
				? void 0
				: _a3.dispose();
			if (!this._token) {
	...
	var TokenizationRegistry = class {
		...
		registerFactory(languageId, factory) {
			var _a3;
			(_a3 = this._factories.get(languageId)) === null || _a3 === void 0
				? void 0
				: _a3.dispose();
	...
	((InlineCompletionTriggerKind3) => {
		InlineCompletionTriggerKind3[(InlineCompletionTriggerKind3.Automatic = 0)] =
			"Automatic";
		InlineCompletionTriggerKind3[(InlineCompletionTriggerKind3.Explicit = 1)] =
			"Explicit";
	})(InlineCompletionTriggerKind || (InlineCompletionTriggerKind = {}));
	var SignatureHelpTriggerKind;
	((SignatureHelpTriggerKind3) => {
		SignatureHelpTriggerKind3[(SignatureHelpTriggerKind3.Invoke = 1)] =
			"Invoke";
		SignatureHelpTriggerKind3[
			(SignatureHelpTriggerKind3.TriggerCharacter = 2)
		] = "TriggerCharacter";
		SignatureHelpTriggerKind3[(SignatureHelpTriggerKind3.ContentChange = 3)] =
			"ContentChange";
	})(SignatureHelpTriggerKind || (SignatureHelpTriggerKind = {}));
	var DocumentHighlightKind;
	((DocumentHighlightKind3) => {
	...
	var _TokenizationRegistry2 = new TokenizationRegistry();
	...
	((CodeActionTriggerType2) => {
		CodeActionTriggerType2[(CodeActionTriggerType2.Invoke = 1)] = "Invoke";
		CodeActionTriggerType2[(CodeActionTriggerType2.Auto = 2)] = "Auto";
	})(CodeActionTriggerType || (CodeActionTriggerType = {}));
	var CompletionItemInsertTextRule;
	((CompletionItemInsertTextRule2) => {
		CompletionItemInsertTextRule2[(CompletionItemInsertTextRule2.None = 0)] =
			"None";
		CompletionItemInsertTextRule2[
	...
	((EditorOption2) => {
		...
		EditorOption2[(EditorOption2.autoClosingOvertype = 8)] =
			"autoClosingOvertype";
		...
		EditorOption2[(EditorOption2.bracketPairColorization = 13)] =
			"bracketPairColorization";
		EditorOption2[(EditorOption2.guides = 14)] = "guides";
		EditorOption2[(EditorOption2.codeLens = 15)] = "codeLens";
		EditorOption2[(EditorOption2.codeLensFontFamily = 16)] =
			"codeLensFontFamily";
		...
		EditorOption2[(EditorOption2.colorDecoratorsLimit = 19)] =
		...
		EditorOption2[(EditorOption2.cursorSurroundingLines = 27)] =
		...
		EditorOption2[(EditorOption2.disableLayerHinting = 30)] =
			"disableLayerHinting";
		...
		EditorOption2[(EditorOption2.emptySelectionClipboard = 35)] =
			"emptySelectionClipboard";
		EditorOption2[(EditorOption2.experimentalWhitespaceRendering = 36)] =
			"experimentalWhitespaceRendering";
		EditorOption2[(EditorOption2.extraEditorClassName = 37)] =
			"extraEditorClassName";
		EditorOption2[(EditorOption2.fastScrollSensitivity = 38)] =
			"fastScrollSensitivity";
		EditorOption2[(EditorOption2.find = 39)] = "find";
		EditorOption2[(EditorOption2.fixedOverflowWidgets = 40)] =
		...
		EditorOption2[(EditorOption2.foldingImportsByDefault = 44)] =
			"foldingImportsByDefault";
		EditorOption2[(EditorOption2.foldingMaximumRegions = 45)] =
		...
		EditorOption2[(EditorOption2.hideCursorInOverviewRuler = 57)] =
		...
		EditorOption2[(EditorOption2.multiCursorModifier = 75)] =
			"multiCursorModifier";
		...
		EditorOption2[(EditorOption2.occurrencesHighlight = 78)] =
			"occurrencesHighlight";
		EditorOption2[(EditorOption2.overviewRulerBorder = 79)] =
			"overviewRulerBorder";
		EditorOption2[(EditorOption2.overviewRulerLanes = 80)] =
			"overviewRulerLanes";
		EditorOption2[(EditorOption2.padding = 81)] = "padding";
		EditorOption2[(EditorOption2.parameterHints = 82)] = "parameterHints";
		EditorOption2[(EditorOption2.peekWidgetDefaultFocus = 83)] =
			"peekWidgetDefaultFocus";
		EditorOption2[(EditorOption2.definitionLinkOpensInPeek = 84)] =
			"definitionLinkOpensInPeek";
		EditorOption2[(EditorOption2.quickSuggestions = 85)] = "quickSuggestions";
		EditorOption2[(EditorOption2.quickSuggestionsDelay = 86)] =
			"quickSuggestionsDelay";
		EditorOption2[(EditorOption2.readOnly = 87)] = "readOnly";
		EditorOption2[(EditorOption2.renameOnType = 88)] = "renameOnType";
		EditorOption2[(EditorOption2.renderControlCharacters = 89)] =
			"renderControlCharacters";
		EditorOption2[(EditorOption2.renderFinalNewline = 90)] =
			"renderFinalNewline";
		EditorOption2[(EditorOption2.renderLineHighlight = 91)] =
			"renderLineHighlight";
		...
		EditorOption2[(EditorOption2.scrollBeyondLastColumn = 99)] =
			"scrollBeyondLastColumn";
		EditorOption2[(EditorOption2.scrollBeyondLastLine = 100)] =
			"scrollBeyondLastLine";
		EditorOption2[(EditorOption2.scrollPredominantAxis = 101)] =
			"scrollPredominantAxis";
		EditorOption2[(EditorOption2.selectionClipboard = 102)] =
			"selectionClipboard";
		EditorOption2[(EditorOption2.selectionHighlight = 103)] =
			"selectionHighlight";
		EditorOption2[(EditorOption2.selectOnLineNumbers = 104)] =
			"selectOnLineNumbers";
		EditorOption2[(EditorOption2.showFoldingControls = 105)] =
			"showFoldingControls";
		EditorOption2[(EditorOption2.showUnused = 106)] = "showUnused";
		EditorOption2[(EditorOption2.snippetSuggestions = 107)] =
			"snippetSuggestions";
		...
		EditorOption2[(EditorOption2.unicodeHighlighting = 120)] =
			"unicodeHighlighting";
		EditorOption2[(EditorOption2.unusualLineTerminators = 121)] =
		...
		EditorOption2[(EditorOption2.wordWrapOverride1 = 130)] =
			"wordWrapOverride1";
		EditorOption2[(EditorOption2.wordWrapOverride2 = 131)] =
			"wordWrapOverride2";
		...
		EditorOption2[(EditorOption2.defaultColorDecorators = 141)] =
			"defaultColorDecorators";
	})(EditorOption || (EditorOption = {}));
	var EndOfLinePreference;
	((EndOfLinePreference2) => {
	...
	((PositionAffinity2) => {
		...
		PositionAffinity2[(PositionAffinity2.LeftOfInjectedText = 3)] =
			"LeftOfInjectedText";
		PositionAffinity2[(PositionAffinity2.RightOfInjectedText = 4)] =
			"RightOfInjectedText";
	})(PositionAffinity || (PositionAffinity = {}));
	var RenderLineNumbersType;
	((RenderLineNumbersType2) => {
	...
	((TextEditorCursorBlinkingStyle2) => {
		...
		TextEditorCursorBlinkingStyle2[(TextEditorCursorBlinkingStyle2.Blink = 1)] =
			"Blink";
		TextEditorCursorBlinkingStyle2[
			(TextEditorCursorBlinkingStyle2.Smooth = 2)
		] = "Smooth";
		TextEditorCursorBlinkingStyle2[(TextEditorCursorBlinkingStyle2.Phase = 3)] =
			"Phase";
		TextEditorCursorBlinkingStyle2[
			(TextEditorCursorBlinkingStyle2.Expand = 4)
		] = "Expand";
		TextEditorCursorBlinkingStyle2[(TextEditorCursorBlinkingStyle2.Solid = 5)] =
			"Solid";
	...
	function once2(computeFn) {
		const cache = {};
		return (input) => {
			if (!Object.hasOwn(cache, input)) {
				cache[input] = computeFn(input);
			}
			return cache[input];
		};
	}
	var _getMapForWordSeparators = once2(
	...
	function assertNever(_value, message = "Unreachable") {
		throw new Error(message);
	}
	...
	function buildRegExpCharClassExpr(codePoints, _flags) {
				...
				return checkAdjacentItems(
					...
					(m1, m2) =>
						m2.originalRange.startLineNumber -
							m1.originalRange.endLineNumberExclusive ===
							m2.modifiedRange.startLineNumber -
								m1.modifiedRange.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
						m1.originalRange.endLineNumberExclusive <
							m2.originalRange.startLineNumber &&
						m1.modifiedRange.endLineNumberExclusive <
							m2.modifiedRange.startLineNumber,
				);
			});
	...
	var DiffAlgorithmResult = class {
		static trivial(seq1, seq2) {
			return new DiffAlgorithmResult(
				[
					new SequenceDiff(
						new OffsetRange(0, seq1.length),
						new OffsetRange(0, seq2.length),
					),
				],
				false,
			);
			...
			for (let s12 = 0; s12 < sequence1.length; s12++) {
				for (let s22 = 0; s22 < sequence2.length; s22++) {
					...
					if (newValue === extendedSeqScore) {
						const prevLen =
							s12 > 0 && s22 > 0 ? lengths.get(s12 - 1, s22 - 1) : 0;
	...
	function smoothenSequenceDiffs(_sequence1, _sequence2, sequenceDiffs) {
		const result = [];
	...
	function joinSequenceDiffs(_sequence1, sequence2, sequenceDiffs) {
		const result = [];
	...
	function shiftSequenceDiffs(sequence1, sequence2, sequenceDiffs) {
		...
		for (let i = 0; i < sequenceDiffs.length; i++) {
			...
			if (diff.seq1Range.isEmpty) {
				const seq2PrevEndExclusive =
					i > 0 ? sequenceDiffs[i - 1].seq2Range.endExclusive : -1;
				const seq2NextStart =
				...
				const seq1PrevEndExclusive =
					i > 0 ? sequenceDiffs[i - 1].seq1Range.endExclusive : -1;
				const seq1NextStart =
					i + 1 < sequenceDiffs.length
	...
	var StandardLinesDiffComputer = class {
		...
		refineDiff(
			...
			const sourceSlice = new Slice(
				originalLines,
				diff.seq1Range,
				considerWhitespaceChanges,
			);
			const targetSlice = new Slice(
				modifiedLines,
				diff.seq2Range,
				considerWhitespaceChanges,
			);
	...
	function coverFullWords(sequence1, sequence2, sequenceDiffs) {
		...
		function maybePushWordToAdditional() {
			...
			if (
				...
				additional.push(
					new SequenceDiff(lastModifiedWord.s1Range, lastModifiedWord.s2Range),
				);
			}
			lastModifiedWord = void 0;
		}
		for (const s of sequenceDiffs) {
			const processWord = (s1Range, s2Range) => {
				var _a3, _b, _c, _d;
				if (
					...
					if (
						...
						lastModifiedWord.deleted +=
							(_a3 =
								s1Added === null || s1Added === void 0
									? void 0
									: s1Added.length) !== null && _a3 !== void 0
								? _a3
								: 0;
						lastModifiedWord.added +=
							(_b =
								s2Added === null || s2Added === void 0
									? void 0
									: s2Added.length) !== null && _b !== void 0
								? _b
								: 0;
				...
				lastModifiedWord.deleted +=
					(_c =
						changedS1 === null || changedS1 === void 0
							? void 0
							: changedS1.length) !== null && _c !== void 0
						? _c
						: 0;
				lastModifiedWord.added +=
					(_d =
						changedS2 === null || changedS2 === void 0
							? void 0
							: changedS2.length) !== null && _d !== void 0
						? _d
						: 0;
			};
	...
	function getIndentation(str) {
		...
		while (
			i < str.length &&
			(str.charCodeAt(i) === 32 || str.charCodeAt(i) === 9)
		) {
			i++;
		}
		return i;
	...
	var Slice = class {
		constructor(lines, lineRange, considerWhitespaceChanges) {
			...
			for (let i = this.lineRange.start; i < this.lineRange.endExclusive; i++) {
				...
				if (i < lines.length - 1) {
					this.elements.push("\n".charCodeAt(0));
					this.firstCharOffsetByLineMinusOne[i - this.lineRange.start] =
		...
		translateOffset(offset) {
			...
			const offsetOfPrevLineBreak =
				i === 0 ? 0 : this.firstCharOffsetByLineMinusOne[i - 1];
			return new Position(
	...
	var EditorSimpleWorker = class {
		...
		static computeDiff(
			...
			const diffAlgorithm =
				algorithm === "advanced"
					? linesDiffComputers.advanced
					: linesDiffComputers.legacy;
		...
		loadForeignModule(_moduleId, createData, foreignHostMethods) {
			const proxyMethodRequest = (method, args) => {
